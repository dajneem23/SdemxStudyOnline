            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="widget subscribe no-box">
                        <a href="${pageContext.request.contextPath}/Home" class="widget-title"><h5 class="widget-title" style="color: red;font-size: 3rem;">Sdemx<span></span></h5></a>
                        <p>About the company, little discription will goes here.. </p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="widget no-box">
                        <h5 class="widget-title">Quick Links<span style="margin-top:60px "></span></h5>
                ...
                <div class="col-md-3 ">
                    <div class="widget no-box ">
                        <h5 class="widget-title ">Contact Us<span style="margin-top:60px "></span></h5>
        ...
        <div class="container ">
            <div class="row ">
                <div class="col-md-12 text-center ">
                    <p>Copyright Sdemx © 2020. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
